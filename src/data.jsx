import program_1 from './assets/camera_solar.jpg';
import program_2 from './assets/camera_solar.jpg';
import program_3 from './assets/camera_solar.jpg';
import program_4 from './assets/camera_solar.jpg';
import program_5 from './assets/camera_solar.jpg';
import program_6 from './assets/camera_solar.jpg';
import program_7 from './assets/Solar_img.jpg';


export const solarPowerData = [
    {
        imageSource: program_1,
        title: 'Solar Water Heaters',
        description: 'We provide these heaters on surfaces with separate pipes connected directly into the houses.'
    },
    {
        imageSource: program_2,
